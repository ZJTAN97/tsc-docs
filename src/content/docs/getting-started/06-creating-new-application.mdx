...
<FileTree>
  - **apps** - entity-dossier - search - workspace - digital-production -
  **generate your new app here** - libs - tsc-components - tsc-utils -
  package.json - tsconfig.base.json - .gitignore - pnpm-lock.yaml - README.md
  -nx.json - biome.json
</FileTree>
...
<FileTree>
  - **apps** - entity-dossier - search - workspace - digital-production -
  YOUR_CREATED_APP - public - src - index.html - tsconfig.app.json -
  tsconfig.json - tsconfig.spec.json - vite.config.ts - libs - tsc-components -
  tsc-utils - package.json - tsconfig.base.json - .gitignore - pnpm-lock.yaml -
  README.md - nx.json - biome.json
</FileTree>
